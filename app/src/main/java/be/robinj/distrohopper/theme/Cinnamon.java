...
public class Cinnamon extends Theme
{
	public Cinnamon()
	{
		...
		this.card_logo = R.drawable.theme_cinnamon_card_logo;
		...
		this.dynamic_background_opacity = R.integer.theme_cinnamon_dynamic_background_opacity;
		...
		this.launcher_bfb_location_supported = R.array.theme_cinnamon_launcher_bfb_location_supported;
		...
		this.launcher_appinfo_image = R.drawable.theme_cinnamon_launcher_appinfo_image;
		...
		this.statusbar_background_when_panel_not_top = R.drawable.theme_cinnamon_statusbar_background_when_panel_not_top;
		this.statusbar_colour_when_panel_hidden = R.drawable.theme_cinnamon_statusbar_colour_when_panel_hidden;
		this.statusbar_follows_launcher_edge = R.bool.theme_cinnamon_statusbar_follows_launcher_edge;
		...
		this.dash_search_width = R.dimen.theme_cinnamon_dash_search_width;
