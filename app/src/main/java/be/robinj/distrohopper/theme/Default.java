...
public class Default extends Theme
{
	public Default ()
	{
		...
		this.dynamic_background_opacity = R.integer.theme_default_dynamic_background_opacity;

		// Launcher //
		this.launcher_location = R.integer.theme_default_launcher_location;
		this.launcher_location_supported = R.array.theme_default_launcher_location_supported;
		...
		this.launcher_bfb_location_supported = R.array.theme_default_launcher_bfb_location_supported;
		...
		this.launcher_trash_image = R.drawable.theme_default_launcher_trash_image;
		this.launcher_appinfo_image = R.drawable.theme_default_launcher_appinfo_image;
		...
		this.launcher_applauncher_backgroundcolour_opacity = R.integer.theme_default_launcher_applauncher_backgroundcolour_opacity;
		this.launcher_applauncher_margin = R.dimen.theme_default_launcher_applauncher_margin;
		this.launcher_applauncher_margin_edge = R.dimen.theme_default_launcher_applauncher_margin_edge;
		...
		this.panel_background_when_dash_opened = R.drawable.theme_default_panel_background_when_dash_opened;
		this.statusbar_background = R.drawable.theme_default_statusbar_background;
		this.statusbar_background_when_panel_not_top = R.drawable.theme_default_statusbar_background_when_panel_not_top;
		this.statusbar_colour_when_panel_hidden = R.drawable.theme_default_statusbar_colour_when_panel_hidden;
		this.statusbar_follows_launcher_edge = R.bool.theme_default_statusbar_follows_launcher_edge;
		this.statusbar_background_when_dash_opened = R.drawable.theme_default_statusbar_background_when_dash_opened;
		...
		this.panel_bfb_image = R.drawable.theme_default_panel_bfb_image;
		...
		this.panel_swap_close_preferences_when_launcher_location = R.array.theme_default_panel_swap_close_preferences_when_launcher_location;
		...
		this.dash_search_width = R.dimen.theme_default_dash_search_width;
		...
		this.profile_indicator = R.integer.theme_default_profile_indicator;
		this.profile_indicator_personal_glyph = R.drawable.dash_ribbon_home;
	}
}
