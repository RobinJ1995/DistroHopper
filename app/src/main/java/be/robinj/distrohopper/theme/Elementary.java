...
public class Elementary extends Theme
{
	public Elementary ()
	{
		...
		this.dynamic_background_opacity = R.integer.theme_elementary_dynamic_background_opacity;
		...
		this.launcher_background = R.array.theme_elementary_launcher_background;
		...
		this.launcher_bfb_location_supported = R.array.theme_elementary_launcher_bfb_location_supported;
		...
		this.launcher_trash_image = R.drawable.theme_elementary_launcher_trash_image;
		this.launcher_appinfo_image = R.drawable.theme_elementary_launcher_appinfo_image;
		...
		this.launcher_applauncher_backgroundcolour_opacity = R.integer.theme_elementary_launcher_applauncher_backgroundcolour_opacity;
		this.launcher_applauncher_margin = R.dimen.theme_elementary_launcher_applauncher_margin;
		this.launcher_applauncher_margin_edge = R.dimen.theme_elementary_launcher_applauncher_margin_edge;
		...
		this.statusbar_background = R.drawable.theme_elementary_statusbar_background;
		this.statusbar_background_when_panel_not_top = R.drawable.theme_elementary_statusbar_background_when_panel_not_top;
		this.statusbar_colour_when_panel_hidden = R.drawable.theme_elementary_statusbar_colour_when_panel_hidden;
		this.statusbar_follows_launcher_edge = R.bool.theme_elementary_statusbar_follows_launcher_edge;
		...
		this.panel_bfb_image = R.drawable.theme_elementary_panel_bfb_image;
		...
		this.panel_swap_close_preferences_when_launcher_location = R.array.theme_elementary_panel_swap_close_preferences_when_launcher_location;
		...
		this.dash_customise_text_colour = R.color.theme_elementary_dash_customise_text_colour;
		this.dash_customise_text_shadow_colour = R.color.theme_elementary_dash_customise_text_shadow_colour;
		this.dash_customise_spinner_text_colour = R.color.theme_elementary_dash_customise_spinner_text_colour;
		this.dash_search_background = R.drawable.theme_elementary_dash_search_background;
		this.dash_search_width = R.dimen.theme_elementary_dash_search_width;
